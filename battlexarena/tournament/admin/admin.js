// Firebase Imports
        ...
        // ===============================================================
        // BattlexArena - Firebase config from Netlify env vars
const _e = window._env_ || {};
        ...
        try {
            // Check if placeholder values are still present
             if (!firebaseConfig.apiKey || !firebaseConfig.projectId) {
                console.warn("BattlexArena Admin: Firebase env vars missing! Set them in Netlify Dashboard.");
